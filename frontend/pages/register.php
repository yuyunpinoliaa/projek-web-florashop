        ...
        <div class="relative z-10 w-full max-w-[440px] fade-in">
            <div class="glass-panel rounded-[32px] p-xl shadow-[0px_4px_20px_rgba(244,114,182,0.08)] border border-white/40">
                ...
                <div class="flex p-xs bg-secondary-fixed/30 rounded-full mb-xl">
                    <a href="login.php" class="flex-1 py-sm px-md rounded-full font-label-md transition-all duration-300 text-secondary hover:text-primary text-center block">Sign In</a>
                    <a href="register.php" class="flex-1 py-sm px-md rounded-full font-label-md transition-all duration-300 bg-white text-primary shadow-sm text-center block">Create Account</a>
                </div>
