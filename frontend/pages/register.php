...
<head>
    <meta charset="utf-8"/>
    <meta content="width=device-width, initial-scale=1.0" name="viewport"/>
    <title>Florashop - Registration</title>
    <script src="https://cdn.tailwindcss.com?plugins=forms,container-queries"></script>
    <link href="https://fonts.googleapis.com/css2?family=Literata:wght@400;500;600;700&family=Plus+Jakarta+Sans:wght@400;500;600;700&display=swap" rel="stylesheet"/>
    <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&display=swap" rel="stylesheet"/>
        ...
        <div class="relative z-10 w-full max-w-[440px] fade-in">
            <div class="glass-panel rounded-[32px] p-xl shadow-[0px_4px_20px_rgba(244,114,182,0.08)] border border-white/40">
                ...
                <div class="flex p-xs bg-secondary-fixed/30 rounded-full mb-xl">
                    <a href="login.php" class="flex-1 py-sm px-md rounded-full font-label-md transition-all duration-300 text-secondary hover:text-primary text-center">Sign In</a>
                    <button class="flex-1 py-sm px-md rounded-full font-label-md transition-all duration-300 bg-white text-primary shadow-sm">Create Account</button>
                </div>
                ...
                <form class="space-y-lg" action="../../backend/auth/proses_register.php" method="POST">
                    <div class="space-y-sm">
                        ...
                        <div class="relative">
                            ...
                            <input class="w-full pl-[48px] pr-md py-md bg-white/50 border border-outline-variant/40 rounded-xl focus:ring-2 focus:ring-primary-container focus:border-primary-container outline-none transition-all placeholder:text-outline/50" id="fullName" name="fullName" placeholder="Jane Doe" type="text" required/>
                        </div>
                    </div>
                    ...
                    <div class="space-y-sm mt-4">
                        <label class="font-label-md text-secondary ml-xs" for="password">Password</label>
                        <div class="relative">
                            <span class="material-symbols-outlined absolute left-md top-1/2 -translate-y-1/2 text-outline text-[20px]">lock</span>
                            <input class="w-full pl-[48px] pr-md py-md bg-white/50 border border-outline-variant/40 rounded-xl focus:ring-2 focus:ring-primary-container focus:border-primary-container outline-none transition-all placeholder:text-outline/50" id="password" name="password" placeholder="Minimum 8 characters" type="password" required/>
                        </div>
                    </div>

                    <p class="font-label-sm text-secondary px-xs mt-4">By signing up, you agree to our <a class="text-primary hover:underline" href="#">Terms of Service</a> and <a class="text-primary hover:underline" href="#">Privacy Policy</a>.</p>
